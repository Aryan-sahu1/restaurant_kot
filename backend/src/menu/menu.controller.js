...
var MenuController = function () {
    var _classDecorators = [(0, common_1.Controller)('menu')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _findAll_decorators;
    var MenuController = _classThis = /** @class */ (function () {
        function MenuController_1(menuService) {
            this.menuService = (__runInitializers(this, _instanceExtraInitializers), menuService);
        }
        MenuController_1.prototype.findAll = function () {
            return this.menuService.findAll();
        };
        return MenuController_1;
    }());
